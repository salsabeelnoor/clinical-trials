    ...
    return (
        <div className='bg-dark_gray sm:bg-white mt-[-2px]'>
            ...
            <div className='bg-light_gray '>
                <div className='sm:container sm:mx-auto mx-3 py-10 sm:grid sm:grid-cols-layout gap-10 place-items-center'>
                    <p className='block text-[15px]'>These studies occur in only a small number of people (often 20 to 80) and the main focus is to ensure the safety
